...
wss.on('connection', async (ws) => {
    ...
    const model = "gemini-2.5-flash-native-audio-preview-12-2025"; // Changed: Use native audio dialog model for better conversational handling and interruptions
    const config = {
        ...
        systemInstruction: `You are Madhulika, a supportive senior interviewer taking interview for assessing personality of candidate, ask questions using this content => ${text}, finally after the end of interview, give feedback . Greet the candidate first and tell about your name`
    };
